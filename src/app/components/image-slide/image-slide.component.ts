...
export class ImageSlideComponent implements OnDestroy {
  // Accept either a list of image URLs or a list of Products (we map to URLs)
  @Input() images: string[] = [];
  ...
  constructor() {
    // No injected raw Object. All data comes via @Input or services from parent.
  }
  ...
  // If products input provided, derive images array
  ...
  private restartTimer() {
    this.clearTimer();
    if (this._autoplay && this.images && this.images.length > 1) {
